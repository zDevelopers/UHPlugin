...
[![Build Status](https://travis-ci.org/AmauryCarrade/UHPlugin.svg?branch=dev)](https://travis-ci.org/AmauryCarrade/UHPlugin) — [![Build Status](http://jenkins.carrade.eu/job/UltraHardcoreReloaded/badge/icon)](http://jenkins.carrade.eu/job/UltraHardcoreReloaded/)
