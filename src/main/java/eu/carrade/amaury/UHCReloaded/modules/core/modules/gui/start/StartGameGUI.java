 ...
 * termes.
 */
package eu.carrade.amaury.UHCReloaded.modules.core.modules.gui.start;
...
public class StartGameGUI extends ActionGui
{
    ...
    {
        mode = UHUtils.getNextElement(mode, 1);
        update();
    }
    ...
    {
        UR.game().setTeleportationMode(mode);
        UR.game().setSlowMode(slow);

        UR.game().setPhase(GamePhase.STARTING);
    }
