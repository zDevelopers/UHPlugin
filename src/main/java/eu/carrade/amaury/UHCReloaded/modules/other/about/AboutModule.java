...
{
    private String shortName = "UHC Reloaded";
    ...
    {
        return UR.get().getDescription().getDescription();
    }
    ...
    {
        return UR.get().getDescription().getAuthors();
    }
    ...
    private void computeGitVersion()
    {
        try
        {
            final Class<? extends UHCReloaded> clazz = UR.get().getClass();
    ...
    {
        final String[] versionParts = UR.get().getDescription().getVersion().split("-", 2);
