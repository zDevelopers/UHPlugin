...
public class Config extends ConfigurationInstance
{
    ...
    static public final ConfigurationItem<Boolean> WEATHER_CYCLE = item("enable-weather-cycle", false);
    static public final ConfigurationItem<WeatherType> INITIAL_WEATHER = item("initial-weather", WeatherType.DOWNFALL);
