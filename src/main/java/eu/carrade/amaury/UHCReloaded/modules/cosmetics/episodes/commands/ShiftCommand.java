 ...
 * termes.
 */
package eu.carrade.amaury.UHCReloaded.modules.cosmetics.episodes.commands;
...
import eu.carrade.amaury.UHCReloaded.modules.cosmetics.episodes.EpisodesModule;
...
public class ShiftCommand extends Command
{
    ...
    protected void run() throws CommandException
    {
        ...
        try
        {
            UR.module(EpisodesModule.class).shift(sender, Integer.parseInt(args[0]));
        }
        catch (ArrayIndexOutOfBoundsException | NumberFormatException e)
        {
            UR.module(EpisodesModule.class).shift(sender);
        }
    }
}
