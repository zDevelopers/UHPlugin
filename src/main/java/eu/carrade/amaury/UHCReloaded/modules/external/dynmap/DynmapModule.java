 ...
 * termes.
 */
package eu.carrade.amaury.UHCReloaded.modules.external.dynmap;
 ...
 */
public class DynmapModule extends UHModule
{
    ...
    public void showSpawnLocation(final OfflinePlayer player, final Location spawnPoint)
    {
        ...
        if (UR.module(GameModule.class).isTeamsGame() && team.size() > 1)
        {
