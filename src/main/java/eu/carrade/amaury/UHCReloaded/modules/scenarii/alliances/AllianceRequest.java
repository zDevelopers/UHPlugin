...
public class AllianceRequest
{
    ...
    public AllianceRequest(final UUID requesterID, final UUID requestedTo)
    {
        ...
        alliances = UR.module(AlliancesModule.class);
    ...
    public void sendApprovalRequests()
    {
        ...
        final UHSound[] jingle = new UHSound[] {
                new UHSound(1f, 0.8f, "ARROW_HIT_PLAYER", "SUCCESSFUL_HIT"),
                new UHSound(1f, 1.4f, "ARROW_HIT_PLAYER", "SUCCESSFUL_HIT"),
                new UHSound(1f, 1.1f, "ARROW_HIT_PLAYER", "SUCCESSFUL_HIT")
        };
    ...
    private void applyApprovedRequest()
    {
        ...
        {
            UR.log(AlliancesModule.class).warning("The alliance request from {0} to {1} was about to be approved but is now invalid.", getName(requesterID), getName(requestedID));
        ...
        final UHSound[] jingle = new UHSound[] {
                new UHSound(1f, 1.10f, "ARROW_HIT_PLAYER", "SUCCESSFUL_HIT"),
                new UHSound(1f, 1.22f, "ARROW_HIT_PLAYER", "SUCCESSFUL_HIT"),
                new UHSound(1f, 1.33f, "ARROW_HIT_PLAYER", "SUCCESSFUL_HIT"),
                new UHSound(1f, 1.44f, "ARROW_HIT_PLAYER", "SUCCESSFUL_HIT"),
                new UHSound(1f, 1.80f, "ENTITY_PLAYER_LEVELUP", "LEVEL_UP", "LEVELUP")
        };
        ...
        UR.log(AlliancesModule.class).info(
