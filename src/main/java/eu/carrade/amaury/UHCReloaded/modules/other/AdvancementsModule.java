 ...
 * termes.
 */
package eu.carrade.amaury.UHCReloaded.modules.other;
...
public class AdvancementsModule extends UHModule
{
    ...
    public void onGameStarts(final GamePhaseChangedEvent ev)
    {
        ...
        UR.get().getWorlds().forEach(world -> world.setGameRuleValue("sendCommandFeedback", oldGameRule.get(world.getName())));
        oldGameRule.clear();
    }
}
