...
import eu.carrade.amaury.quartzsurvivalgames.modules.core.sidebar.SidebarInjector.SidebarPriority;
...
public class EpisodesModule extends QSGModule {
    ...
    protected void onEnable() {
        ...
        QSG.ifLoaded(PlayerListHeaderFooterModule.class, headFoot -> {
